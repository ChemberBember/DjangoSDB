...
class UserData(models.Model):
    ...
    UserAvatar = models.ImageField(upload_to='./static/DbImages/DBimages',null=True,default='./static/DbImages/DBimages/userunknown.jpg')
    UserGitLink = models.CharField(max_length=50, null = True)
    UserGroup = models.CharField(max_length=15, null = True)

class Projects(models.Model):
    Usernick = models.ForeignKey(UserData, on_delete=models.CASCADE)
